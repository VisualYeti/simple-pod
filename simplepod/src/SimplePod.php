...
namespace visualyeti\simplepod;
 ...
 * @since     0.1.0
 *
 * @property  CrawlAPIServiceService $crawlAPIService
 * @property  Settings $settings
 * @method    Settings getSettings()
 */
class SimplePod extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'simple-pod/crawl-a-p-i-controller';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'simple-pod/crawl-a-p-i-controller/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('simplePod', SimplePodVariable::class);
            }
        );
